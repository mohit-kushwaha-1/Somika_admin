...
const AllTrip = () => {
    ...
    // http://localhost:80/api/v1/trip/findAllTrip
  ...
  //  employeeCosts:item?.employeeCosts,
    ...
    const columns = [
        {
          title:!filterN? 'Vehicle Number':"Name",
          dataIndex:!filterN? 'vehicle_number':'name',
          key: 'vehicle_number',
        },

        {
          title:filterN? 'Email':"",
          dataIndex:filterN? 'Email':'',
          key: 'Email',
        },

        {
          title:filterN? 'Bording Point':"",
          dataIndex:filterN? 'BoradingPoint':'',
          key: 'BoradingPoint',
        },
        {
          title:filterN? 'Destination Ponint':"",
          dataIndex:filterN? 'DestinationPonint':'',
          key: 'DestinationPonint',
        },

        {
          title:filterN? 'Start time':"",
          dataIndex:filterN? 'starttime':'',
          key: 'starttime',
        },

        {
          title:filterN? 'Status':"",
          dataIndex:filterN? 'status':'',
          key: 'status',
        },
        ...
        {
          title:!filterN? 'Capacity':'',
          dataIndex: !filterN?'capacity':'',
          key: 'capacity',
        },
        ...
        {
          title: !filterN?'Type':'',
          dataIndex: !filterN?'type':'',
          key: 'type',
        },
    
        {
          title:!filterN? 'Current Location':'',
          dataIndex: 'currentLocation',
          key: 'currentLocation',
        },

        {
            title: !filterN?'Destination Location':'',
            dataIndex: !filterN?'destinationLocation':'',
            key: 'destinationLocation',
          },
        {
          title: !filterN?'PickUp Time':'',
          dataIndex: !filterN?'pickUpTime':'',
          key: 'pickUpTime',
        },

        {
            title:!filterN? 'Pick UpDate':'',
            dataIndex: !filterN?'pickUpDate':'',
            key: 'pickUpDate',
          },
